...
class RoundedAngleEnd(Gtk.DrawingArea, Widget):
    ...
    def animate_height(self, value: int, duration: float, bezier_curve: tuple = (0.5, 0.25, 0, 1)):
    ...
    def animate_width(self, value: int, duration: float, bezier_curve: tuple = (0.5, 0.25, 0, 1)):
    ...
    def on_draw(self, _, cr: cairo.Context):
        ...
        if border_width:
            ...
            self.render_shape(cr, width, height)
            cr.stroke()
