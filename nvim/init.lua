...
require('lazy').setup({
  ...
  { 'numToStr/Comment.nvim', 
    opts = {toggler = {line = '<leader>c', block = '<leader>bc'}}},
...

  {
    ...
    config = function()
          ...
          pylsp = {
            plugins = {
              pycodestyle = {
                ...
                maxLineLength = 800, -- Set the maximum line length
              },
            },
          },
        },
      ...
      -- Add other LSP configurations below
      -- For example:
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        return {
          -- turn auto format on save on/off
          dry_run = true,
          timeout_ms = 500,
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'python', 'hyprlang', 'css', 'toml' },
